	                ...
	                <tbody>
	                	...
	                	<tr>
		                	...
		                	<td class="text-center icon-statte">
	                            <form action="{{route('employee.delete',$employee->id)}}" method="post" accept-charset="utf-8">
			                		<a href="{{route('employee.edit',$employee->id)}}" class="btn btn-circle btn-alt-info mr-5 mb-5">
...
<!-- employee add modal -->
<div class="modal show" id="modal-large" tabindex="-1" employee="dialog" aria-labelledby="modal-large">
    <div class="modal-dialog modal-lg" employee="document">
                    	...
                    	<form action="{{route('employee.store')}}" method="post" enctype="multipart/form-data">
	                        ...
	                        <div class="form-group row">
	                            <div class="col-md-6 mb-2">
	                            	<label class="col-12" for="employee">Employee Name: <span class="text-danger">*</span></label>
		                            <div class="col-lg-12">
	                            ...
	                            <div class="col-md-6 mb-2">
	                            	<label class="col-12" for="employee">Password: <span class="text-danger">*</span></label>
		                            <div class="col-lg-12">
