                            ...
                            <div class="content content-full overflow-hidden">
                                ...
                                <div class="py-30 text-center">
                                    <a class="link-effect text-pulse font-w700" href="index.html">
                                        ...
                                        <span class="font-size-xl text-pulse-dark">Global Visa Solution</span><span class="font-size-xl"> - (GVS)</span>
                                    </a>
                                        ...
                                        <div class="block-content bg-body-light">
                                            <div class="form-group text-center">
                                                <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="/">
                                                    <i class="fa fa-user text-muted mr-5"></i> Not you? Please Visit Our Website
                                                </a>
                                            </div>
                                        </div>
                                    </div>
